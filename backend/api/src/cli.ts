...
const OPTIONS = {
  ...
  "stats-prune-interval-ms": { type: "string" },
...
export function parseCliArgs(argv: string[]): CliResult {
  ...
  if (values["stats-prune-interval-ms"] !== undefined) overrides.statsPruneIntervalMs = Number(values["stats-prune-interval-ms"]);
...
Options:
  ...
  --stats-prune-interval-ms <n> Minimum time between prune passes over the stats DB (default: 3600000, i.e. 1 hour)
